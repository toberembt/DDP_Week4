...
shinyUI(
  ...
  navbarPage(
    ...
    "Predicting the MPG using multiple variables",
    ...
    tabPanel(
      ...
      "About the Model",
      p("Developing Data Products course - Assignment Week 4 - Shiny Application and Reproducible Pitch"),

      p("Author: Tyler Oberembt"),
